...
Written content is CC BY-SA 4.0 and hardware designs are CERN-OHL-W v2; see [openh2.org/licensing](https://openh2.org/licensing). The source code in this repository is not licensed for reuse (see `LICENSE`).

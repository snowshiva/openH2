...
Hardware designs documented on the site are open under CERN-OHL-W v2; see [openh2.org/licensing](https://openh2.org/licensing). Copyright and terms for everything else are in `LICENSE`.
